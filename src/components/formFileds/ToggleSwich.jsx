...
export default function ToggleSwich({ lable, desc, storagePram, setNewAdStorageValue, newAdStorageValue }) {

    const handleInput = (e) => {
        setNewAdStorageValue({ ...newAdStorageValue, [`${storagePram}`]: e.target.checked })
    }
    return (
        <div className="w-full p-2 flex flex-col gap-4">
            <div className="w-full flex justify-between items-center pb-2 ]">
                ...
                <label className="inline-flex items-center  cursor-pointer">
                    <input onClick={handleInput} type="checkbox" className="sr-only peer" checked={newAdStorageValue !== undefined && newAdStorageValue[storagePram]} readOnly />

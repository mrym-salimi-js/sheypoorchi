...
export function ArrowLeft({ size, color, stroke }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function PencilFill({ color, size }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function Saved({ size, color, fill }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
...
export function Visible({ size, color }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function InVisible({ size, color }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'

...
export default function Dashboard() {
  return (
    <>
      <div className='w-full h-full bg-gray-50 flex flex-col gap-7 px-3 md:px-7 items-end justify-center'>
        <Menu />
        <div className='w-full h-full md:w-[65%]  lg:w-[75%] xl:w-[80%] p-2 pt-6 flex flex-col items-center gap-8'>
          ...
          <div className='w-full  grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3'>
            <FCalendar />
            <div className='w-full h-60 p-4 shadow-md rounded-3xl bg-white'></div>
            <div className='w-full h-60 p-4  shadow-md rounded-3xl bg-white'></div>
          </div>
        </div>
      </div>
